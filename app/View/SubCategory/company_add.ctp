...
<section class="content">
	<div class="row">
      ...
      <?php $isEdit = (!empty($this->request->data['SubCategory']['id']))?1:0; ?>
    ...
    <div class="form-group col-sm-6 fl-left">
          <label class="col-sm-3 control-label required" for="inputPassword3">Main Category</label>
            <div class="col-sm-9">
             <?php echo $this->Form->input('cat_id', array('label'=>false,'class'=>'form-control','options'=>$categories,'empty'=>'Select Main Category','required'=>true,'title'=>'Please select main category.')); ?>
           </div>
         </div>
         <div class="form-group col-sm-6 fl-left">
