	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				<tr><th><?php echo $this->Paginator->sort('name');?></th><th><?php echo $this->Paginator->sort('status');?></th><th class="pull-right"><?php echo __('Actions');?></th></tr>
				<?php
				foreach ($Languages as $language):
				?>
				<tr>
					<td><?php echo $language['Language']['name']; ?></td>
					<td><?php echo getActiveInactive($language['Language']['status']); ?></td>
					<td class="pull-right">
						<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $language['Language']['id']),array('class'=>'btn btn-default btn-sm btn-primary')); ?>
					</td>
				</tr>
				<?php endforeach; ?>
			</table>
