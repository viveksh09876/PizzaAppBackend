	...
	<div class="row">
		<div class="col-xs-12">
			...
			<?php 
				...
				echo $this->Form->input('coupon_name',array('placeholder'=>'Coupon Name','label'=>false,'class'=>'fl-left form-control','div'=>array('class'=>'col-md-3','style'=>'padding-left:0px;'),'empty'=>'All'));
			...
			<table class="table table-hover">
				<tr><th><?php echo $this->Paginator->sort('coupon_name');?></th><th><?php echo $this->Paginator->sort('coupon_code');?></th><th><?php echo $this->Paginator->sort('application');?></th><th><?php echo $this->Paginator->sort('description');?></th><th><?php echo $this->Paginator->sort('status');?></th><th class="pull-right"><?php echo __('Actions');?></th></tr>
				<?php
