	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table class="table table-hover">
				<tr><th><?php  echo $this->Paginator->sort('store_id','Store Name');?></th><th><?php  echo $this->Paginator->sort('name','Modifier Name');?></th><th><?php echo $this->Paginator->sort('plu_code','PLU Code');?></th><th><?php echo $this->Paginator->sort('image');?></th><th><?php echo $this->Paginator->sort('sort_order');?></th><th><?php echo $this->Paginator->sort('status');?></th><th class="pull-right"><?php echo __('Actions');?></th></tr>
				<?php
				foreach ($Options as $Option):
				?>
				<tr>
					<td><?php echo $this->General->getStoreNameById($Option['Option']['store_id']); ?></td> 
