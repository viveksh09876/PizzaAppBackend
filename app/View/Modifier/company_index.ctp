...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
			...
			<?php 
				echo $this->Form->create('Search',array('url'=>array('controller'=>'modifier','action'=>'index'),'type'=>'GET')); 
			...
			<table class="table table-hover">
				<tr><th><?php  echo $this->Paginator->sort('store_id','Store Name');?></th><th><?php  echo $this->Paginator->sort('titel','Modifier');?></th><th><?php echo $this->Paginator->sort('short_description');?></th><th><?php echo $this->Paginator->sort('image');?></th><th><?php echo $this->Paginator->sort('sort_order');?></th><th><?php echo $this->Paginator->sort('status');?></th><th class="pull-right"><?php echo __('Actions');?></th></tr>
				<?php
				foreach ($Modifiers as $Modifier):
				?>
				<tr>
					<td><?php echo $this->General->getStoreNameById($Modifier['Modifier']['store_id']); ?></td>
