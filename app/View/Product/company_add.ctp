...
<section class="content">
	<div class="row">
        ...
        <?php $isEdit = (!empty($this->request->data['Product']['id']))?1:0; ?>
        ...
        <div class="form-group col-sm-6 fl-left">
          ...
          <div class="col-sm-9">
           <?php echo $this->Form->input('sub_category_id', array('label'=>false,'options'=>array(),'class'=>'form-control','empty'=>'Select Sub Category')); ?>
         </div>
        </div>
