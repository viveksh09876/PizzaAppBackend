...
function getDataByDate(val){
	 ...
	 if(arg=='This Day Last Month'){
	  ...
	  if(arg=='Custom'){
		 ...
		 if(SD && ED){
			window.location.href='<?php echo $this->webroot;?>company/reports/index/'+SD+'/'+ED;
			sessionStorage.setItem('selectedOpt', arg);
			sessionStorage.setItem('selectedDate', customVal);
		 }else{
			 window.location.href='<?php echo $this->webroot;?>company/reports/index';
...
$(function(){
	...
	$('#datepicker1').on('changeDate', function() {
		...
		window.location.href='<?php echo $this->webroot;?>company/reports/index/'+sDate+'/'+eDate;
