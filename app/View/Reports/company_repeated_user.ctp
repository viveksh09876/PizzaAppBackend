...
<tr>
<td><?php echo $i;?></td>
	<td><a href="<?php echo $this->webroot;?>company/reports/ordersDetail/<?php echo $rUser['NewOrderhistory']['UserId'];?>"><?php echo $rUser['Ecuser']['FirstName'].' '.$rUser['Ecuser']['LastName'];?></a> </td><td><strong><?php echo $rUser['NewOrderhistory']['count'];?></strong></td>
	</tr>
<?php $i++;}?>
</table>
</div>
